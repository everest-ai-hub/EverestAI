      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-6xl md:text-8xl font-serif font-black text-white mb-8 leading-[0.9] tracking-tight fade-in-up-delay-1">
            Pioneering the
            <span className="block text-accent font-light italic">Future of AI</span>
          </h1>
          ...
          <p className="text-xl md:text-2xl text-white/85 mb-12 max-w-4xl mx-auto leading-relaxed font-sans font-light fade-in-up-delay-2">
            We are visionary technologists, data scientists, and industry experts dedicated to making artificial
            intelligence accessible, ethical, and transformative for enterprises worldwide.
          </p>
